...
public class Coche {
    ...
    public String toString() {
        return "Coche{" 
                ...
                + ", ruedaDelanteraIzquierda=" + ruedaDelanteraIzquierda 
                + ", ruedaDelanteraDerecha=" + ruedaDelanteraDerecha 
                + ", ruedaTraseraIzquierda=" + ruedaTraseraIzquierda 
                + ", ruedaTraseraDerecha=" + ruedaTraseraDerecha +
                '}';
    }
